...
Once we found lambda, we re-trained the model then found the RMSE and generated our plots.
...
Now we did the same steps using the log of price as the output variable.
