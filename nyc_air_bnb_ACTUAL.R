...
preds_bag_nycAB <- predict(bag_nycAB, newdata = train_sample)
#prediction of test data
preds_bag_nycAB_test<- predict(bag_nycAB, newdata = test_sample)

#MSE test
MSE(preds_bag_nycAB_test, test_sample$log_price)
#.1968789

#MSE train
MSE(preds_bag_nycAB, train_sample$log_price)
#.1808592
